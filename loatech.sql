...
(7, 'peticion_pendiente', 'pendiente', 12, '2025-07-25 14:04:37', NULL, 0, NULL, NULL, NULL),
(8, 'peticion_pendiente', 'pendiente', 13, '2025-07-25 14:13:57', NULL, 0, NULL, NULL, NULL),
(9, 'peticion_pendiente', 'pendiente', 14, '2025-07-25 14:50:59', NULL, 0, NULL, NULL, NULL),
(10, 'peticion_pendiente', 'pendiente', 15, '2025-07-25 15:12:28', NULL, 0, NULL, NULL, NULL),
(11, 'peticion_pendiente', 'pendiente', 16, '2025-07-25 15:33:48', NULL, 0, NULL, NULL, NULL),
(12, 'peticion_pendiente', 'pendiente', 17, '2025-07-25 15:51:58', NULL, 0, NULL, NULL, NULL),
(13, 'peticion_pendiente', 'pendiente', 18, '2025-07-25 16:08:51', NULL, 0, NULL, NULL, NULL),
(14, 'peticion_pendiente', 'pendiente', 19, '2025-07-27 21:17:14', NULL, 0, NULL, NULL, NULL),
(15, 'peticion_pendiente', 'pendiente', 20, '2025-07-27 21:49:53', NULL, 0, NULL, NULL, NULL),
(16, 'peticion_pendiente', 'pendiente', 21, '2025-07-28 11:44:34', NULL, 0, NULL, NULL, NULL),
(17, 'peticion_pendiente', 'pendiente', 22, '2025-07-28 11:59:14', NULL, 0, NULL, NULL, NULL),
(18, 'peticion_pendiente', 'pendiente', 23, '2025-07-28 12:06:57', NULL, 0, NULL, NULL, NULL),
(19, 'peticion_pendiente', 'pendiente', 24, '2025-07-28 12:46:14', NULL, 0, NULL, NULL, NULL),
(20, 'peticion_pendiente', 'pendiente', 25, '2025-07-28 13:22:31', NULL, 0, NULL, NULL, NULL),
(21, 'peticion_pendiente', 'pendiente', 26, '2025-07-28 13:59:25', NULL, 0, NULL, NULL, NULL),
...
INSERT INTO `prestamos` (`IDpre`, `cantidad`, `formacionodependencia`, `cargopre`, `lugardetraslado`, `IDdetalle`, `IDautorizacion`, `IDelementos`, `IDpersonas`, `motivo_rechazo`, `fecha_solicitud`) VALUES
(9, 1, 'adso', 'funcionario', 'la casa', 3, 6, 13, 32, NULL, '2025-07-27 17:15:57'),
(10, 5, 'adso', 'funcionario', 'la casa', 4, 7, 13, 41, NULL, '2025-07-27 17:15:57'),
(11, 2, 'adso', 'funcionario', 'la casa', 5, 8, 13, 41, NULL, '2025-07-27 17:15:57'),
(12, 2, 'adso', 'instructor', 'la casa', 6, 9, 12, 41, NULL, '2025-07-27 17:15:57'),
(13, 2, 'adso', 'funcionario', 'la casa', 7, 10, 12, 41, NULL, '2025-07-27 17:15:57'),
(14, 1, 'adso', 'funcionario', 'la casa', 8, 11, 13, 41, NULL, '2025-07-27 17:15:57'),
(15, 1, 'ADSO', 'funcionario', 'crra 4e 2a 104', 9, 12, 12, 30, NULL, '2025-07-27 17:15:57'),
(16, 1, 'ADSO', 'funcionario', 'crra 4e 2a 104', 10, 13, 14, 30, NULL, '2025-07-27 17:15:57'),
(17, 1, 'ADSO', 'funcionario', 'crra 4e 2a 104', 11, 14, 14, 30, NULL, '2025-07-27 17:15:57'),
(18, 1, 'ADSO', 'funcionario', 'crra 4e 2a 104', 12, 15, 14, 30, NULL, '2025-07-27 17:15:57'),
(19, 1, 'ADSO', 'instructor', 'crra 4e 2a 104', 13, 16, 14, 30, '45', '2025-07-27 17:15:57'),
(20, 1, 'ADSO', 'funcionario', 'crra 4e 2a 104', 14, 17, 14, 30, NULL, '2025-07-27 17:15:57'),
(21, 1, 'ADSO', 'funcionario', 'crra 4e 2a 105', 15, 18, 14, 30, 'xd', '2025-07-27 17:15:57'),
(22, 1, 'ADSO', 'APRENDIZ', 'mi casa papi', 16, 19, 15, 30, 'xd', '2025-07-27 17:15:57'),
(23, 1, 'ADSO 2874006', 'APRENDIZ', 'ambiente 9', 17, 20, 15, 30, 'xd', '2025-07-27 17:15:57'),
(24, 1, 'ingenieria de software', 'aprendiz', 'salon 08', 18, 21, 16, 30, 'xd', '2025-07-28 06:44:34'),
(25, 1, 'ingenieria de sistemas', 'aprendiz', 'ambiente 09', 19, 22, 16, 30, 'no tiene stock', '2025-07-28 06:59:14'),
(26, 1, 'ingenieria de informatica', 'aprendiz', 'ambiente 07', 20, 23, 16, 30, NULL, '2025-07-28 07:06:57'),
(27, 1, 'adso', 'funcionario', 'salon 05', 21, 24, 16, 30, 'xd', '2025-07-28 07:46:14'),
...
--
ALTER TABLE `ingresoelementos`
  MODIFY `IDingele` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `marcaciones`
--
ALTER TABLE `marcaciones`
  MODIFY `IDmarc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `vigilantes`
  MODIFY `idvig` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

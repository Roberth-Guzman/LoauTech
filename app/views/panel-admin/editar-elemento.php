...
<body class="bg-gray-100">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-10">
            ...
            <!-- Formulario de Editar Elemento -->
            <div class="bg-white shadow-md rounded-lg p-6">
                <form action="<?= BASE_URL ?>/admin/editarElemento" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            <?php if (!empty($data['imagen'])): ?>
                                <div class="mb-4">
                                    <p class="text-gray-700 font-medium mb-2">Imagen Actual</p>
                                    <img src="<?= BASE_URL ?>/public/img/elementos/<?= htmlspecialchars($data['imagen']) ?>" alt="Imagen del elemento" class="h-40 object-contain border rounded p-2">
                                </div>
                            <?php endif; ?>

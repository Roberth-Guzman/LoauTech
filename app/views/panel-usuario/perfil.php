...
<body class="bg-gray-100">
      ...
      <main class="p-6">
        <div class="max-w-4xl mx-auto">
          <div class="bg-white rounded-lg shadow-sm overflow-hidden mb-6">
            ...
            <div id="editar-perfil" class="seccion-perfil px-6 py-4 bg-gray-50 border-t border-gray-200 hidden">
              <form method="POST" action="<?= BASE_URL ?>/usuario/perfil" class="space-y-6" enctype="multipart/form-data">
            ...
            <div id="cambiar-password" class="seccion-perfil px-6 py-4 bg-gray-50 border-t border-gray-200 hidden">
              <form method="POST" action="<?= BASE_URL ?>/usuario/perfil" class="space-y-6" enctype="multipart/form-data">
                <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                  <div class="sm:col-span-6">
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-end space-x-3">
              <button onclick="mostrarSeccion('editar-perfil')" class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-md hover:bg-blue-700">
                <i class="fas fa-user-edit mr-2"></i>Editar Perfil
              </button>
              <button onclick="mostrarSeccion('cambiar-password')" class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-green-600 rounded-md hover:bg-green-700">
  ...
  <div id="modalSubirFoto" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
      <div class="mt-3">
        <form action="<?= BASE_URL ?>/usuario/actualizarAvatar" method="post" enctype="multipart/form-data" id="avatarForm">
          ...
          <div class="mb-4">
            <label for="avatar" class="block text-sm font-medium text-gray-700 mb-2">Seleccionar imagen</label>
          ...
          <div class="flex justify-end space-x-3">
            ...
            <button type="submit" id="btnSubirAvatar"
                    class="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700">
              <span id="btnText">Subir Foto</span>
  ...
  document.getElementById('avatarForm').addEventListener('submit', function(e) {
    ...
    const btnSubmit = document.getElementById('btnSubirAvatar');

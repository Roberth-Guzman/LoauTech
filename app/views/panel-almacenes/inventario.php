            ...
            <div class="p-6">
                ...
                <div id="inventory-management-content" class="space-y-4">
                    <div class="flex flex-col md:flex-row justify-between gap-4 mb-6">
                        <!-- Botón de Agregar -->
                        <a href="<?php echo BASE_URL; ?>/almacen/agregarElemento" 
                                    ...
                                    <tr class="border-b border-gray-200 hover:bg-gray-50">
                                        ...
                                        <td class="py-3 px-4">
                                            <div class="flex space-x-2">
                                                <a href="<?php echo BASE_URL; ?>/almacen/detalleElemento/<?php echo $elemento->IDele; ?>" 
                                                   class="text-blue-600 hover:text-blue-800" 
                                                   title="Ver detalles">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="<?php echo BASE_URL; ?>/almacen/editarElemento/<?php echo $elemento->IDele; ?>" 

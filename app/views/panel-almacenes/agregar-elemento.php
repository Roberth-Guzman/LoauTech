...
<body class="bg-gray-100">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-10">
            ...
            <div class="mb-4">
                <a href="<?= BASE_URL ?>/almacen/inventario" class="text-blue-600 hover:underline">
            ...
            <div class="bg-white shadow-md rounded-lg p-6">
                <form action="<?= BASE_URL ?>/almacen/agregarElemento" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mt-6 flex justify-end">
                        <a href="<?= BASE_URL ?>/almacen/inventario" class="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 mr-2">
                            Cancelar
                        </a>

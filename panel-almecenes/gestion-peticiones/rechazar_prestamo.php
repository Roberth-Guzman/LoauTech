...
try {
    ...
    $stmtAprobacion->bind_param("iss", $idPrestamo, $motivo, $usuario);
    $stmtAprobacion->execute();
    $stmtAprobacion->close();

    // 5. Actualizar el préstamo con el motivo del rechazo
    ...
    // 6. Registrar el motivo del rechazo

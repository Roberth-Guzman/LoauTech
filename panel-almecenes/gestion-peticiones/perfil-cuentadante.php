...
<body class="bg-light">
    <div class="container-fluid vh-100 d-flex flex-column p-0">
        <div class="bg-primary text-white p-3 d-flex justify-content-between align-items-center">
            <a href="panel-peticiones.php" class="text-white fs-4 text-decoration-none" onclick="window.location.reload(true);">
                <i class="bi bi-arrow-left"></i>
            </a>
            <h1 class="mb-0 fs-4 fw-bold text-center flex-grow-1">PERFIL DE CUENTADANTE</h1>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-10">
                    ...
                    <div class="d-grid gap-2 mb-4">
                        <a href="editar-cuentadante.php" class="btn btn-primary">

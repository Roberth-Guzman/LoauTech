...
if (!isset($_SESSION['usuario']) || $_SESSION['usuario']['rol'] !== 'almacenes') {
...
$sqlTotal = "SELECT COUNT(*) as total
             ...
             WHERE (a.estadoaut = 'aprobado' OR a.estadoaut = 'rechazado') 
             AND ap.tipo_aprobacion = 'almacen'";
...
<head>
    ...
    <title>Historial de Aprobaciones - Almacenes</title>
    ...
    <div class="min-h-screen">
        ...
        <nav class="bg-gray-800 text-white shadow-lg">
            <div class="container mx-auto px-4 py-3 flex justify-between items-center">
                <div class="flex items-center space-x-2">
                    ...
                    <span class="font-bold">Gestión de Inventario - Almacenes</span>
                </div>
        ...
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-600">Registro de todas las solicitudes aprobadas y rechazadas por almacenes</p>
            </div>
            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-md">
                <div class="px-4 py-5 sm:px-6">
                    ...
                    <p class="mt-1 max-w-2xl text-sm text-gray-500">
                        Historial completo de decisiones tomadas por almacenes
                    </p>
                </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            if ($result && $result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    if ($row['estado_autorizacion'] === 'aprobado') {
